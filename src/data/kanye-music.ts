...
export const albums: Album[] = [
  ...
  },
  {
    ...
    songs: [
      ...
      { title: 'Drunk and Hot Girls', artists: ['Kanye West', 'Mos Def'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/6b/2b/ba/6b2bbad6-0c70-c500-c1c8-17a009488260/mzaf_11406950899012790617.plus.aac.p.m4a' },
      ...
      { title: 'Everything I Am', artists: ['Kanye West', 'scratches by DJ Premier'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/1f/22/c8/1f22c8ad-ee46-556a-4954-fc6e144e8cdd/mzaf_6785579153574032848.plus.aac.p.m4a' },
      ...
      { title: 'Homecoming', artists: ['Kanye West', 'Chris Martin'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/a0/b6/ac/a0b6ac24-9509-19e7-85a7-0be507d17c02/mzaf_5643812388289006313.plus.aac.p.m4a' },
  ...
  },
  {
    ...
    songs: [
      ...
      { title: 'New Day', artists: ['Jay-Z', 'Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/fb/e7/27/fbe7279a-fc00-c421-93a3-876a06f03507/mzaf_10795976663115751955.plus.aac.p.m4a' },
      ...
      { title: 'Why I Love You', artists: ['Jay-Z', 'Kanye West', 'Mr Hudson'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/78/2e/44/782e44eb-2e77-822b-4e60-e77ffd46780e/mzaf_1491220347254865318.plus.aac.p.m4a' },
    ],
  },
  {
    id: 'yeezus',
    ...
    songs: [
      { title: 'On Sight', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview112/v4/9b/27/a0/9b27a0f4-e1e2-222b-4830-bd24eaef2294/mzaf_14934294178063565967.plus.aac.p.m4a' },
      { title: 'Black Skinhead', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview112/v4/0c/10/8f/0c108f4d-c3dc-4374-ceb3-080aaaadc341/mzaf_17782097658048434538.plus.aac.p.m4a' },
      { title: 'I Am a God', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview112/v4/e5/8b/76/e58b7630-8371-ffa7-8eec-3078b9ee10bc/mzaf_3218386073213106415.plus.aac.p.m4a' },
      { title: 'New Slaves', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview112/v4/cc/56/91/cc56913e-84ec-cd16-fcaa-441f137d5316/mzaf_9652476523309647888.plus.aac.p.m4a' },
      { title: 'Hold My Liquor', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview122/v4/df/72/7a/df727a6e-4528-9c2c-2f56-eae749b349e6/mzaf_9588358575683787954.plus.aac.p.m4a' },
      { title: "I'm in It", artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview122/v4/4c/4f/aa/4c4faa57-89d8-9980-1e37-5d5fa12a3d4c/mzaf_646621625631060069.plus.aac.p.m4a' },
      { title: 'Blood on the Leaves', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview122/v4/01/25/db/0125db87-80aa-2b15-472d-504944f41075/mzaf_16729972049053369636.plus.aac.p.m4a' },
      { title: 'Guilt Trip', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview122/v4/a5/c3/23/a5c32318-8480-ed66-b24f-f0cd2c430012/mzaf_738208866388853560.plus.aac.p.m4a' },
      { title: 'Send It Up', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview122/v4/ab/6c/28/ab6c28df-1876-ce05-a366-e99cd9c3160c/mzaf_1806454590831631155.plus.aac.p.m4a' },
      { title: 'Bound 2', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview112/v4/be/b7/b9/beb7b904-ac44-6b6b-24d7-442ac9860d55/mzaf_11431443335651220653.plus.aac.p.m4a' },
    ],
  },
  {
  ...
  },
  {
    ...
    songs: [
      { title: 'Feel the Love', artists: ['Kid Cudi', 'Kanye West', 'Pusha T'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/5e/e9/d5/5ee9d50c-9bd4-4f0a-ee29-d6daec536768/mzaf_12575119251292237880.plus.aac.p.m4a' },
      { title: 'Fire', artists: ['Kid Cudi', 'Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/a8/f4/16/a8f416de-fbe2-4d23-ed07-a54a2c1eb058/mzaf_17205738435893376103.plus.aac.p.m4a' },
      { title: '4th Dimension', artists: ['Kid Cudi', 'Kanye West', 'Louis Prima'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/c9/ad/3a/c9ad3a9e-d9c2-60af-5b1a-8863ce47dea7/mzaf_10559010511034037632.plus.aac.p.m4a' },
      { title: 'Freeee (Ghost Town, Pt. 2)', artists: ['Kid Cudi', 'Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/50/a2/53/50a25320-280b-7bcf-f395-b213ad1608e5/mzaf_10600615286425267248.plus.aac.p.m4a' },
      { title: 'Reborn', artists: ['Kid Cudi', 'Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/07/ea/81/07ea811f-c4b4-5287-bcfe-7a732f827577/mzaf_8304734503199002850.plus.aac.p.m4a' },
      { title: 'Kids See Ghosts', artists: ['Kid Cudi', 'Kanye West', 'Yasiin Bey'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/10/88/4e/10884ed2-0915-107c-5000-36b9c1b137aa/mzaf_1685242710228336877.plus.aac.p.m4a' },
      { title: 'Cudi Montage', artists: ['Kid Cudi', 'Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/ea/38/15/ea381592-410e-fd7e-37bb-613c54e9d763/mzaf_18158242067927548497.plus.aac.p.m4a' },
    ],
  },
  {
    id: 'jesus-is-king',
    ...
    songs: [
      ...
      { title: 'Hands On', artists: ['Kanye West', 'Fred Hammond'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/9a/79/5c/9a795c53-6d1a-4081-0f0c-87091db5b242/mzaf_7816718042413076413.plus.aac.p.m4a' },
  ...
  },
  {
    ...
    songs: [
      { title: 'Donda Chant', artists: ['Kanye West'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/1a/e8/b8/1ae8b863-26d8-75f4-a97b-b5de75147e3d/mzaf_18348254956782292549.plus.aac.p.m4a' },
  ...
  },
  {
    ...
    year: 2024,
    artworkUrl:
      'https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/c2/0c/a5/c20ca53d-ae1e-31eb-af1d-faffc0b1b286/354766.jpg/600x600bb.jpg',
    songs: [
      { title: 'STARS', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/7b/85/3c/7b853c40-f07a-4b99-c520-ad8b65a11c17/mzaf_13349340834303862481.plus.aac.p.m4a' },
      { title: 'KEYS TO MY LIFE', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/c2/bb/30/c2bb3028-c921-ec64-0f4f-0243cff6c044/mzaf_5078252285739616247.plus.aac.p.m4a' },
      { title: 'PAID', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/35/04/3a/35043a5a-2422-ca2b-eae0-afd8a57e1aa3/mzaf_15881675718443383180.plus.aac.p.m4a' },
      { title: 'TALKING', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/71/11/a6/7111a65c-fcdd-fc77-4ff4-630cec293bec/mzaf_11268430209587901165.plus.aac.p.m4a' },
      { title: 'BACK TO ME', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/a3/94/e3/a394e3d6-266c-521c-33cb-26dc17b24d21/mzaf_12894457605195665795.plus.aac.p.m4a' },
      { title: 'HOODRAT', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/34/f1/e4/34f1e408-d495-edbc-8e97-f3df0a2fb943/mzaf_2159024196856888862.plus.aac.p.m4a' },
      { title: 'DO IT', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/a9/e7/46/a9e74656-a546-7e90-710f-afd86bbb053b/mzaf_3289022826885499972.plus.aac.p.m4a' },
      { title: 'PAPERWORK', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/7c/70/3f/7c703fa0-85df-78d9-861b-819e369db4a8/mzaf_2674358238989465053.plus.aac.p.m4a' },
      { title: 'BURN', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/2d/41/c5/2d41c530-39e6-5e89-55cd-b1de34b83ddd/mzaf_9019250531015700791.plus.aac.p.m4a' },
      { title: 'FUK SUMN', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/44/22/05/44220591-e812-178e-af92-978af796eed1/mzaf_15767941803738997134.plus.aac.p.m4a' },
      { title: 'VULTURES', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/af/9f/4c/af9f4ca9-4957-d74e-51d5-ae5e20e0a895/mzaf_11298250367303466846.plus.aac.p.m4a' },
      { title: 'CARNIVAL', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/b2/fb/be/b2fbbe6e-4888-4b1d-703f-4f5cbbfbae09/mzaf_8893228201669252333.plus.aac.p.m4a' },
      { title: 'BEG FORGIVENESS', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/98/19/c6/9819c6da-3ac9-0653-89f8-9c84d16ded5d/mzaf_1524023231667617085.plus.aac.p.m4a' },
      { title: 'PROBLEMATIC', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/af/61/55/af615596-693e-a064-9e92-1298e7c70f66/mzaf_10879115346879039120.plus.aac.p.m4a' },
      { title: 'KING', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/32/f0/bb/32f0bb0e-69cc-aa7a-4adb-200e0923938d/mzaf_15886833497417801019.plus.aac.p.m4a' },
    ],
  },
  {
    id: 'vultures-2',
    ...
    year: 2024,
    artworkUrl:
      'https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/bf/db/25/bfdb25f8-1518-d6d9-32ad-053cc9f87d88/357949.jpg/600x600bb.jpg',
    songs: [
      { title: 'SLIDE', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/e1/b5/1b/e1b51b98-7fe1-67e4-5add-6ead875e20db/mzaf_2299285839544226958.plus.aac.p.m4a' },
      { title: 'TIME MOVING SLOW', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/67/04/69/67046952-84d9-8c00-a3ff-11850b951d4e/mzaf_13749474000509773145.plus.aac.p.m4a' },
      { title: 'FIELD TRIP', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/24/0f/e1/240fe1a0-83c1-ca80-3909-9be0611099a9/mzaf_4935315518745323117.plus.aac.p.m4a' },
      { title: 'FRIED', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/59/b2/e5/59b2e5cc-b40d-6de0-80fc-1af75da07b63/mzaf_3765337234699639348.plus.aac.p.m4a' },
      { title: 'ISABELLA', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/60/68/f0/6068f02c-272e-bd48-2377-5417b8879c85/mzaf_551981911798176101.plus.aac.p.m4a' },
      { title: 'PROMOTION', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/5d/17/90/5d1790e6-13c3-d38d-57b8-66f7e68c9cc5/mzaf_6100398171729732019.plus.aac.p.m4a' },
      { title: '530', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/4d/60/81/4d608116-d65d-5d4f-fd3b-850b53e90ed7/mzaf_727642052770543701.plus.aac.p.m4a' },
      { title: 'DEAD', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/c0/b8/97/c0b89743-50a8-976a-027a-c7dd5d0bd32c/mzaf_9514658860281927673.plus.aac.p.m4a' },
      { title: 'FOREVER ROLLING', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/ac/32/90/ac32902d-274e-00e2-9eca-f8a033cebcca/mzaf_1374251289818665618.plus.aac.p.m4a' },
      { title: 'BOMB', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/ad/65/d1/ad65d13d-4947-8a77-dfa3-2929638db0bd/mzaf_5182514215312692499.plus.aac.p.m4a' },
      { title: 'RIVER', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/4e/d4/41/4ed4411c-79c0-8e18-eaad-cb3381a2c39a/mzaf_17830961259574188069.plus.aac.p.m4a' },
      { title: 'FOREVER', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/fc/c8/2e/fcc82eaa-cb36-93f2-4f6d-2cacf3ab01e8/mzaf_16976232406164626001.plus.aac.p.m4a' },
      { title: 'HUSBAND', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/b0/bd/c0/b0bdc0a5-ceba-469d-484d-8d0c1a44c14e/mzaf_16797999178831970438.plus.aac.p.m4a' },
      { title: 'LIFESTYLE', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/21/d6/e4/21d6e438-85db-5645-fba6-0c1a9091fd2e/mzaf_3623914709765461519.plus.aac.p.m4a' },
      { title: 'SKY CITY', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/d6/94/7c/d6947c7d-4a70-3346-6317-dd33734083cd/mzaf_17332266534743828621.plus.aac.p.m4a' },
      { title: 'MY SOUL', artists: ['Kanye West', 'Ty Dolla Sign'], previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/b3/26/50/b3265029-faf2-d1e4-27d1-29fd0d284ceb/mzaf_5596205030149438720.plus.aac.p.m4a' },
    ],
  },
  {
    id: 'bully',
