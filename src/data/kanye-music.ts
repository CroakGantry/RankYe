...
export const albums: Album[] = [
  {
    ...
    songs: [
      { title: 'Intro (Skit)', artists: ['Kanye West'] },
      ...
      { title: 'Workout Plan (Skit)', artists: ['Kanye West'] },
      ...
      { title: 'School Spirit (Skit 1)', artists: ['Kanye West'] },
      { title: 'School Spirit', artists: ['Kanye West'] },
      { title: 'School Spirit (Skit 2)', artists: ['Kanye West'] },
      { title: 'Lil Jimmy (Skit)', artists: ['Kanye West'] },
