...
import { ChevronUp, ChevronDown, Trophy, Award, FileDown } from 'lucide-react';
...
export const SongRankingSystem = ({
  ...
  return <div className="min-h-screen bg-[#0f0f0f] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        }} className={cn('flex items-center gap-2 px-6 py-3 rounded-lg', 'bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f]', 'border border-white/10 hover:border-white/20', 'text-white font-semibold', 'transition-all duration-300', 'hover:shadow-lg hover:shadow-orange-500/20', 'hover:scale-105 active:scale-95')}>
